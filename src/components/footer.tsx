...
const Footer = () => {
  return (
    <div>
      <section className="py-10 bg-black text-white sm:pt-16 lg:pt-16 md:rounded-md">
          ...
          <div className="flex gap-4 items-center justify-between mb-8">
            <div className="flex gap-4 items-center">
              <Image
                ...
                alt=""
              />
              <p className="text-2xl">Savitribai Phule Pune University</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              ...
              <p className="text-base leading-relaxed mt-7">
                Savitribai Phule Pune University Ganeshkhind Road, Pune
              </p>
              <p className="text-base leading-relaxed mt-7">
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 ">
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li>
                  ...
                  >
                    {" "}
                    PG Diploma In Blockchain Project Management{" "}
                  </a>
                </li>
      ...
      <p className="text-sm text-center text-black my-4">
